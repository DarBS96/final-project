FeelEat application # final-project <br/>
<br/>
...
Therefore, I built an interactive recipe web app where users can get/create/edit/save/rate recipes based on their current mood. <br/>
